...
export default function Component() {
  ...
  {main_state.header_state.withNav.map((lgdmzfwa, i) => (
  <Link as={NextLink} href={lgdmzfwa.at(1)} key={i} sx={{"opacity": "0.85", "transition": "opacity 600ms ease", "_hover": {"textDecoration": "None", "opacity": "1"}}}>
  ...
  <Button onClick={_e => Event([E("_set_clipboard", {content:"$ reflex export --no-zip"})], _e)} sx={{"position": "absolute", "top": "0.5em", "right": "0"}}>
  <CopyIcon/>
</Button>
</Box>
</Box>
  ...
  <Button onClick={_e => Event([E("_set_clipboard", {content:"$ cd .web"})], _e)} sx={{"position": "absolute", "top": "0.5em", "right": "0"}}>
  <CopyIcon/>
</Button>
</Box>
</Box>
  ...
  <Button onClick={_e => Event([E("_set_clipboard", {content:"$ cd _static"})], _e)} sx={{"position": "absolute", "top": "0.5em", "right": "0"}}>
  <CopyIcon/>
</Button>
</Box>
</Box>
...
`}
  ...
  <Button onClick={_e => Event([E("_set_clipboard", {content:"_static/\n\u2502\n\u251c\u2500\u2500 _next/\n\u2502   \u2514\u2500\u2500 ...\n\u2502\n\u251c\u2500\u2500 home/\n\u2502   \u2514\u2500\u2500 start.html\n\u2502\n\u251c\u2500\u2500 setup/\n\u2502   \u251c\u2500\u2500 color.html\n\u2502   \u2514\u2500\u2500 setup.html\n\u2502\n\u251c\u2500\u2500 404.html\n\u251c\u2500\u2500 favicon.ico\n\u2514\u2500\u2500 index.html\n"})], _e)} sx={{"position": "absolute", "top": "0.5em", "right": "0"}}>
  <CopyIcon/>
</Button>
</Box>
</Box>
  ...
  <HStack spacing={`2rem`} sx={{"alignItems": "end", "transition": "opacity 500ms ease 500ms"}}>
  {main_state.header_state.withNav.map((njyqqxha, i) => (
  <Link as={NextLink} href={njyqqxha.at(1)} key={i} sx={{"opacity": "0.85", "transition": "opacity 600ms ease", "_hover": {"textDecoration": "None", "opacity": "1"}}}>
  <Heading size={`s`} sx={{"paddingTop": "0.3rem", "color": "white", "fontWeight": "semibold"}}>
  {njyqqxha.at(0)}
</Heading>
</Link>
