...
export default function Component() {
  ...
  {main_state.header_state.withNav.map((wezlbtge, i) => (
  <Link as={NextLink} href={wezlbtge.at(1)} key={i} sx={{"opacity": "0.85", "transition": "opacity 600ms ease", "_hover": {"textDecoration": "None", "opacity": "1"}}}>
...
`}
  ...
  <HStack spacing={`2rem`} sx={{"alignItems": "end", "transition": "opacity 500ms ease 500ms"}}>
  {main_state.header_state.withNav.map((zrfjwxkz, i) => (
  <Link as={NextLink} href={zrfjwxkz.at(1)} key={i} sx={{"opacity": "0.85", "transition": "opacity 600ms ease", "_hover": {"textDecoration": "None", "opacity": "1"}}}>
  <Heading size={`s`} sx={{"paddingTop": "0.3rem", "color": "white", "fontWeight": "semibold"}}>
  {zrfjwxkz.at(0)}
</Heading>
</Link>
