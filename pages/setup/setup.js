...
export default function Component() {
  ...
  {main_state.header_state.withNav.map((jpxskiyu, i) => (
  <Link as={NextLink} href={jpxskiyu.at(1)} key={i} sx={{"opacity": "0.85", "transition": "opacity 600ms ease", "_hover": {"textDecoration": "None", "opacity": "1"}}}>
...
`}
  ...
  <Accordion allowMultiple={true} sx={{"width": "100%", "paddingTop": "1rem", "paddingBottom": "1rem"}}>
  <AccordionItem sx={{"padding": "0.25rem 0rem"}}>
  <AccordionButton>
  <Heading size={`md`}>
  {`Core`}
</Heading>
  ...
  <AccordionPanel>
  <Prism customStyle={{"width": "100%"}} language={`plaintext`} style={dark} sx={{"width": "100%"}}>
  {`│app/
├── core/
│   ├── __init__.py
│   ├── base.py
...
`}
  ...
  <HStack spacing={`2rem`} sx={{"alignItems": "end", "transition": "opacity 500ms ease 500ms"}}>
  {main_state.header_state.withNav.map((cttfmxgc, i) => (
  <Link as={NextLink} href={cttfmxgc.at(1)} key={i} sx={{"opacity": "0.85", "transition": "opacity 600ms ease", "_hover": {"textDecoration": "None", "opacity": "1"}}}>
  <Heading size={`s`} sx={{"paddingTop": "0.3rem", "color": "white", "fontWeight": "semibold"}}>
  {cttfmxgc.at(0)}
</Heading>
</Link>
