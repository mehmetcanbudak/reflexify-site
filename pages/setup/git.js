...
export default function Component() {
  ...
  {main_state.header_state.withNav.map((aiaqhkud, i) => (
  <Link as={NextLink} href={aiaqhkud.at(1)} key={i} sx={{"opacity": "0.85", "transition": "opacity 600ms ease", "_hover": {"textDecoration": "None", "opacity": "1"}}}>
...
`}
  ...
  <HStack spacing={`2rem`} sx={{"alignItems": "end", "transition": "opacity 500ms ease 500ms"}}>
  {main_state.header_state.withNav.map((lfgrnbrc, i) => (
  <Link as={NextLink} href={lfgrnbrc.at(1)} key={i} sx={{"opacity": "0.85", "transition": "opacity 600ms ease", "_hover": {"textDecoration": "None", "opacity": "1"}}}>
  <Heading size={`s`} sx={{"paddingTop": "0.3rem", "color": "white", "fontWeight": "semibold"}}>
  {lfgrnbrc.at(0)}
</Heading>
</Link>
