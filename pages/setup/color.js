...
export default function Component() {
  ...
  {main_state.header_state.withNav.map((cywtvaoy, i) => (
  <Link as={NextLink} href={cywtvaoy.at(1)} key={i} sx={{"opacity": "0.85", "transition": "opacity 600ms ease", "_hover": {"textDecoration": "None", "opacity": "1"}}}>
...
`}
  ...
  <Button onClick={toggleColorMode} sx={{"width": "100%"}}>
  <Fragment>
  {isTrue((colorMode === "light")) ? (
  <Fragment>
  <SunIcon/>
...
`}
  ...
  <Container onClick={...args => {setHeaderColor('black')}} sx={{"w": "64px", "h": "64px", "bg": "black"}}>
  {`black`}
</Container>
  <Container onClick={...args => {setHeaderColor('teal')}} sx={{"w": "64px", "h": "64px", "bg": "teal"}}>
  {`teal`}
</Container>
  <Container onClick={...args => {setHeaderColor('blue')}} sx={{"w": "64px", "h": "64px", "bg": "blue"}}>
  {`blue`}
</Container>
  <Container onClick={...args => {setHeaderColor('yellow')}} sx={{"w": "64px", "h": "64px", "bg": "yellow"}}>
  {`yellow`}
</Container>
  <Container onClick={...args => {setHeaderColor('orange')}} sx={{"w": "64px", "h": "64px", "bg": "orange"}}>
  {`orange`}
</Container>
  <Container onClick={...args => {setHeaderColor('indigo')}} sx={{"w": "64px", "h": "64px", "bg": "indigo"}}>
  {`indigo`}
</Container>
  <Container onClick={...args => {setHeaderColor('cyan')}} sx={{"w": "64px", "h": "64px", "bg": "cyan"}}>
  {`cyan`}
</Container>
  <Container onClick={...args => {setHeaderColor('purple')}} sx={{"w": "64px", "h": "64px", "bg": "purple"}}>
  {`purple`}
</Container>
</HStack>
</VStack>
  ...
  <HStack spacing={`2rem`} sx={{"alignItems": "end", "transition": "opacity 500ms ease 500ms"}}>
  {main_state.header_state.withNav.map((uzpijoqv, i) => (
  <Link as={NextLink} href={uzpijoqv.at(1)} key={i} sx={{"opacity": "0.85", "transition": "opacity 600ms ease", "_hover": {"textDecoration": "None", "opacity": "1"}}}>
  <Heading size={`s`} sx={{"paddingTop": "0.3rem", "color": "white", "fontWeight": "semibold"}}>
  {uzpijoqv.at(0)}
</Heading>
</Link>
