...
export default function Component() {
  ...
  {main_state.header_state.withNav.map((fnftqwqw, i) => (
  <Link as={NextLink} href={fnftqwqw.at(1)} key={i} sx={{"opacity": "0.85", "transition": "opacity 600ms ease", "_hover": {"textDecoration": "None", "opacity": "1"}}}>
...
`}
  ...
  <HStack spacing={`2rem`} sx={{"alignItems": "end", "transition": "opacity 500ms ease 500ms"}}>
  {main_state.header_state.withNav.map((nnwabvuv, i) => (
  <Link as={NextLink} href={nnwabvuv.at(1)} key={i} sx={{"opacity": "0.85", "transition": "opacity 600ms ease", "_hover": {"textDecoration": "None", "opacity": "1"}}}>
  <Heading size={`s`} sx={{"paddingTop": "0.3rem", "color": "white", "fontWeight": "semibold"}}>
  {nnwabvuv.at(0)}
</Heading>
</Link>
